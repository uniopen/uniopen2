(function (args) {
    ...
    return httpGet(args.url).then((res) => {
        ...
        commitData(args.uni, args.type, args.code, args.url, args.key, { note: 'Pizzeria Ae Oche Note' });

        // let raw = { nome: args.raw.nome, indirizzo: args.raw.indirizzo, note: 'Pizzeria Ae Oche Note' };
